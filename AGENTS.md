...
│  ├─ /api/chat (Codex AI, @require_api_key)          │
...
React app structure, the MOCA design system, multi-workspace architecture, Brand & UI tokens, and key UI component docs live in `mass-market-app/AGENTS.md` (loads automatically when working on files under `mass-market-app/`).
