...
const T = {
  en: {
    ...
    disclaim: 'Sample of market prices, refreshed twice a day. The final price is shown on the provider’s page. Links are affiliate links: we and the hotel may earn a commission, at no extra cost to you.',
  ...
  he: {
    ...
    disclaim: 'מדגם ממחירי השוק, מתעדכן פעמיים ביום. המחיר הסופי מוצג בעמוד הספק. הקישורים הם קישורי שותפים: אנחנו והמלון עשויים לקבל עמלה, ללא עלות נוספת לכם.',
  ...
  fr: {
    ...
    trust: 'Comparé parmi <b>38 fournisseurs eSIM mondiaux</b> et <b>10 opérateurs israéliens</b><br>Actualisé deux fois par jour par l’intelligence de marché MOCA',
    trustAbroad: 'Comparé parmi <b>38 fournisseurs eSIM mondiaux</b><br>Actualisé deux fois par jour par l’intelligence de marché MOCA',
    disclaim: 'Échantillon de prix du marché, actualisé deux fois par jour. Le prix final s’affiche sur la page du fournisseur. Liens d’affiliation : nous et l’hôtel pouvons percevoir une commission, sans surcoût pour vous.',
  ...
  ru: {
    ...
    trust: 'Сравнение по <b>38 мировым операторам eSIM</b> и <b>10 израильским операторам</b><br>Обновляется дважды в день аналитикой MOCA',
    trustAbroad: 'Сравнение по <b>38 мировым операторам eSIM</b><br>Обновляется дважды в день аналитикой MOCA',
    disclaim: 'Образец рыночных цен, обновляется дважды в день. Итоговая цена указана на странице поставщика. Партнёрские ссылки: мы и отель можем получить комиссию без дополнительной платы для вас.',
