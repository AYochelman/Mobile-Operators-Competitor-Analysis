 ...
 *        Partner   — "Boost" tier ONLY. The "גלישה ברשת Private 5G" line appears
 *                     on ALL Partner 5G plans (King/Queen included) — it brands
 *                     the network itself, not the prioritized tier — so it must
 *                     NOT be used as a priority signal.
