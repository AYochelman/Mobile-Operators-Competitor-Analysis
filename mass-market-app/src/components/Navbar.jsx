      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-gray-200/60 sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 h-12 flex items-center justify-between">
          ...
          <NavLink to="/" className="flex items-center gap-2">
            <span className="text-sm font-semibold text-gray-900 tracking-tight">Mass Market</span>
            <span className="text-[10px] text-gray-400 hidden sm:inline">Alon Yochelman</span>
          </NavLink>
