...
export default function Modal({ open, onClose, title, children, maxWidth = 'max-w-lg' }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-2 md:p-4 animate-fade-in" onClick={onClose}>
      ...
      <div className={`relative bg-white rounded-xl shadow-modal ${maxWidth} w-full max-h-[92vh] md:max-h-[80vh] overflow-y-auto p-4 md:p-6 animate-fade-in-up`} onClick={e => e.stopPropagation()}>
