...
const FAQ = [
  { q: 'כמה עולה חבילת סלולר בישראל?',
    a: 'לפי הנתונים שנאספים (ספטמבר 2026, משתנים מעת לעת), המחירים נעים בין כ-10 שקלים לחודש למסלולים בסיסיים ועד כ-130 שקלים לחבילות פרימיום עם 5G מתועדף. רוב החבילות עם נפח גלישה גדול נמצאות בטווח של 20-60 שקלים לחודש. ההשוואה בעמוד מתעדכנת פעמיים ביום מאתרי המפעילים.' },
