...
const head = `<meta charset="UTF-8" />
    ...
    <meta name="description" content="A guest-facing portal, branded in your hotel's colors, that compares every eSIM &amp; tourist-SIM deal in Israel in real time — 27 global providers and 10 local operators. No inventory, no operations, and a commission to the hotel on every purchase." />
