...
const rootContent =
  ...
  `<p style="font-size:18px;color:#8a6a4a;max-width:620px;margin:0 auto 28px">השוואת מחירים חינמית, בלי הרשמה. מוצאים חבילת eSIM מתאימה לטיול, מושווה על פני 38 ספקי eSIM גלובליים ומתעדכן פעמיים ביום.</p>` +
