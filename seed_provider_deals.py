...
DEALS = [
    ...
    # ══ NOT CONTACTED ═════════════════════════════════════════════════════════
    {
        ...
        "coupon_note": "3 קופוני צד-ג' (ADAMANDLINDS וכו') נמחקו סופית 2026-09-11 לבקשת המפעיל. אין קוד MOCA משלנו עד לחוזה.",
    ...
    {
        "provider_id": "venterrasim", "display_name": "VenterraSIM", "category": "global",
        "is_israeli": True,
        "outreach_status": "not_contacted",
        "contact": "support@venterrasim.com (אין טלפון/וואטסאפ פומבי באתר)",
        "agreement_status": "none",
        "coupon_note": "אין קופון. תוכנית שותפים לא ידועה - לשאול בפנייה ראשונה.",
        "has_tracking_link": False, "priority": "med",
        "next_actions": "פנייה ראשונה ל-support@venterrasim.com - שיתוף פעולה / לינק מעקב / קופון MOCA.",
        "notes": "ספק ישראלי (נוסף 25/08/2026): אתר עברית ראשי (venterrasim.com) + 4 שפות. ~1,017 חבילות בשקלים, 188 מדינות + 14 חבילות אזוריות/גלובליות. סריקה מ-API ציבורי אחד (/api/v1/plans/, מותר מפורשות ב-robots.txt שלהם). כל המחירים עם הנחה קבועה 20% ממחיר מחירון.",
    },
    {
        "provider_id": "simzol", "display_name": "Simzol", "category": "global",
        "is_israeli": True,
        "outreach_status": "not_contacted",
        "contact": "טלפון 03-5320202; טופס יצירת קשר באתר. עוסק: סימר אילן מיכאל משה (פטור), ע.מ. 302469432",
        "agreement_status": "none",
        "coupon_note": "אין קופון. תוכנית שותפים לא ידועה - לשאול בפנייה ראשונה.",
        "has_tracking_link": False, "priority": "low",
        "next_actions": "פנייה ראשונה בטלפון/טופס - שיתוף פעולה / לינק מעקב / קופון MOCA.",
        "notes": "משווק ישראלי קטן (נוסף 25/08/2026): חנות CashCow ללא API. נקלטו 20 חבילות eSIM בשקלים בלבד (גלובלי / גאורגיה / איחוד האמירויות / ארצות הברית ללא הגבלה), זיהוי לפי breadcrumb של קטגורית eSIM. הסימים הפיזיים שלהם (אירופה/ארצות הברית/פלטינום) לא נקלטים במכוון.",
    },
    {
